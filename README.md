...
- **Animaciones al Scroll**: Sistema de revelado progresivo utilizando la API de `Intersection Observer`.
- **Navegación Fluida**: Enrutamiento optimizado con `React Router` y auto-scroll al tope.
- **Cronograma de Misión**: Línea de tiempo interactiva detallando cada fase del vuelo.
...
1. Clonar el repositorio:
   ```bash
   git clone https://github.com/Nahuelito22/Nahuel_Artemis2.git
   ```
